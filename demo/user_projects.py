    ...
    return rx.dialog.root(
        rx.dialog.trigger(
            rx.button(
                ...
                rx.text("Add Project", size="4"), color="primary"
            ),
        ),
        rx.dialog.content(
            rx.hstack(
                ...
                rx.vstack(
                    rx.dialog.title("Add Project",
                                    weight="bold",
                                    margin="0",
                                    ),
                    rx.dialog.description(
                        "fill the project name and workspace ID",
                    ),
                    spacing="1",
                    height="100%",
                    align_items="start",
            ...
            rx.flex(
                rx.form.root(
                    ...
                    rx.flex(
                        ...
                        rx.form.submit(
                            rx.dialog.close(
                                rx.button("Add Project", color="primary"),
                            ),
                            as_child=True,
                        ),
                        padding_top="2em",
                    ...
                    on_submit=State.add_project_to_db,
